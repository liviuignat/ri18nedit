        ...
        link: function(scope, element, attributes) {
            ...
            '<div ng-switch on="showAddKey" class="block" >'
                ...
                + '<span ng-switch-default>'
                    // plus button
                    + '<button class="addObjectItemBtn" ng-click="$parent.showAddKey = true"><i class="icon-add glyphicon glyphicon-plus"></i></button>'
                + '</span>'
            + '</div>';
            ...
            if (scope.type == "object"){
                ...
                + ' ng-init="chevron = \'icon-chevron-down glyphicon glyphicon-chevron-down\'"></i>'
                ...
                + '<div class="jsonContents" ng-hide="collapsed">'
                    ...
                    + '<span class="block" ng-hide="key.indexOf(\'_\') == 0" ng-repeat="(key, val) in child">'
                        ...
                        + '<span class="jsonObjectKey">'
                            ...
                            // delete button
                            + '<i class="deleteKeyBtn icon-trash glyphicon glyphicon-trash" ng-click="deleteKey(child, key)"></i>'
                        + '</span>'
                        // object value
                ...
                var template = '<i ng-click="toggleCollapse()" ng-class="chevron" ng-init="chevron = \'icon-chevron-down glyphicon glyphicon-ctrash\'"></i>'
                ...
                + '<div class="jsonContents" ng-hide="collapsed">'
                    + '<ol class="arrayOl" ui-multi-sortable ng-model="child">'
                        ...
                        + '<li class="arrayItem" ng-repeat="val in child" ng-init="key=$index">' //key needed in moveKey()
                            // delete button
                            + '<i class="deleteKeyBtn icon-trash glyphicon glyphicon-trash" ng-click="deleteKey(child, $index)"></i>'
                            + '<i class="moveArrayItemBtn icon-align-justify glyphicon glyphicon-align-justify"></i>'
